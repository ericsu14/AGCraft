...
public class GiantBruin extends UCLAFaction implements NMSSkillUser
{
	public GiantBruin ()
	{
		...
		this.setStat(MonsterStat.EXPERIENCE, 800.0);
	...
	public void loadNMSSkills(EntityInsentient nmsMob, LivingEntity entity) 
	{
		...
		nmsMob.bR.a(1, new PathfinderGoalGiantFireball((EntityGiantZombie) nmsMob, entity));
		...
		nmsMob.bR.a(4, new PathfinderGoalMeleeAttack ((EntityCreature) nmsMob, 1.0D, true));
	}
}
