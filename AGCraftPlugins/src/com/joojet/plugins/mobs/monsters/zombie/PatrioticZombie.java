...
{	
	public PatrioticZombie ()
	{
		...
		this.setDropRates(0.15f, 0.10f, 0.10f, 0.10f, 0.05f, 0.75f);
		...
		this.offhand = new ItemStack (Material.FIREWORK_ROCKET, 16);
		FireworkMeta firework = (FireworkMeta) this.offhand.getItemMeta();
		firework.addEffect(FireworkEffect.builder().withColor(Color.BLUE).withTrail().withFlicker().with(Type.STAR).build());
		firework.addEffect(FireworkEffect.builder().withColor(Color.WHITE).withTrail().withFlicker().with(Type.STAR).build());
		firework.addEffect(FireworkEffect.builder().withColor(Color.RED).withTrail().withFlicker().with(Type.STAR).build());
		firework.setPower(3);
		firework.setDisplayName(this.americanizeText("Freedom"));
		this.offhand.setItemMeta(firework);
	}
