...
public class AlliedAttackBuffSkill extends AttackBuffSkill 
{
	/** Creates an allied attack buff skill that can be used by allies without the high threat score requirements */
	public AlliedAttackBuffSkill(int amplifier, int duration, int range, int cooldown, int weight) 
	{
