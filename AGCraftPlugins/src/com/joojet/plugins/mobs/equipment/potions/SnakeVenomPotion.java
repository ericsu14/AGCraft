...
public class SnakeVenomPotion extends SplashPotionEquipment 
{
	...
	protected void addPotionData() 
	{
		...
		this.addLoreToItemMeta(StringUtil.alternateTextColors("Mr. Johnson", TextPattern.WORD, ChatColor.BLUE, ChatColor.GOLD) + "'s special delivery bundled in a small package!");
	}
