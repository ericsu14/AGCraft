package com.joojet.plugins.mobs.pathfinding.util;
...
public class LaserBeam {
    ...
    */
    public LaserBeam (Location start, Location end, int duration, int distance) throws ReflectiveOperationException {
        this.start = start;
        this.end = end;
